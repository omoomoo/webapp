...
<body>
	...
	<form:form action="${loginUrl}" method="POST" id="loginForm">
		<fieldset>
			<legend><strong>登录系统</strong></legend>
			<!-- 登陆表单 -->
			<label for="username">用户名 </label>
			<input type="text" name="username" id="username" class="inputText" style="margin-bottom:15px;"/>
			<label for="password" style="margin-top:5px;">密&nbsp;&nbsp;码 </label>
